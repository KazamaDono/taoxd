...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 29 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch29-fuzzing-1 test        # build the target(s) and run the exploit test
```
