...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 24 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch24-kernel-intro test        # build the target(s) and run the exploit test
```
