# Chapter 22 — companion code

Deliberately vulnerable teaching artifacts and working exploits for Chapter 22 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch22-rw-to-rce test        # build the target(s) and run the exploit test
```
