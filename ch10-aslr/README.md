...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 10 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch10-aslr test        # build the target(s) and run the exploit test
```
