# Chapter 31 — companion code

Deliberately vulnerable teaching artifacts and working exploits for Chapter 31 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch31-static-variant test        # build the target(s) and run the exploit test
```
