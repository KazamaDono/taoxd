# Chapter 26 — companion code

Deliberately vulnerable teaching artifacts and working exploits for Chapter 26 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch26-linux-kernel-2 test        # build the target(s) and run the exploit test
```
