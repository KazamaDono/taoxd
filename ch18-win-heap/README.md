# Chapter 18 — companion code

Deliberately vulnerable teaching artifacts and working exploits for Chapter 18 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch18-win-heap test        # build the target(s) and run the exploit test
```
