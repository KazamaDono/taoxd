...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 11 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch11-canary test        # build the target(s) and run the exploit test
```
