...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 3 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch03-arch test        # build the target(s) and run the exploit test
```
