# Chapter 33 — companion code

Deliberately vulnerable teaching artifacts and working exploits for Chapter 33 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch33-patchdiff test        # build the target(s) and run the exploit test
```
