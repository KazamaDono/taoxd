...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 5 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch05-stack test        # build the target(s) and run the exploit test
```
