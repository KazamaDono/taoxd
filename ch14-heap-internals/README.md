...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 14 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch14-heap-internals test        # build the target(s) and run the exploit test
```
