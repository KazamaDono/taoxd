...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 12 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch12-cfi test        # build the target(s) and run the exploit test
```
