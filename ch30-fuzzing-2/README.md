# Chapter 30 — companion code

Deliberately vulnerable teaching artifacts and working exploits for Chapter 30 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch30-fuzzing-2 test        # build the target(s) and run the exploit test
```
