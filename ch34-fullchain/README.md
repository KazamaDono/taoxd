# Chapter 34 — companion code

Deliberately vulnerable teaching artifacts and working exploits for Chapter 34 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch34-fullchain test        # build the target(s) and run the exploit test
```
