...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 8 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch08-rop test        # build the target(s) and run the exploit test
```
