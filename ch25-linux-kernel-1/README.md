# Chapter 25 — companion code

Deliberately vulnerable teaching artifacts and working exploits for Chapter 25 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch25-linux-kernel-1 test        # build the target(s) and run the exploit test
```
