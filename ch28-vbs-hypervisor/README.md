...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 28 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch28-vbs-hypervisor test        # build the target(s) and run the exploit test
```
