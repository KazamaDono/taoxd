...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 13 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch13-hwmit test        # build the target(s) and run the exploit test
```
