# Chapter 16 — companion code

Deliberately vulnerable teaching artifacts and working exploits for Chapter 16 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch16-houses test        # build the target(s) and run the exploit test
```
