...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 21 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch21-jit test        # build the target(s) and run the exploit test
```
