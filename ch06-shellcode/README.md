...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 6 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch06-shellcode test        # build the target(s) and run the exploit test
```
