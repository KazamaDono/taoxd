...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 1 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch01-mindset test        # build the target(s) and run the exploit test
```
