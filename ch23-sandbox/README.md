...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 23 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch23-sandbox test        # build the target(s) and run the exploit test
```
