...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 4 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch04-re test        # build the target(s) and run the exploit test
```
