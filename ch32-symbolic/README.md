...
Deliberately vulnerable teaching artifacts and working exploits for Chapter 32 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch32-symbolic test        # build the target(s) and run the exploit test
```
