# Chapter 27 — companion code

Deliberately vulnerable teaching artifacts and working exploits for Chapter 27 of *Modern Exploit Development*. **Lab use only** — see `../ETHICS.md`.
...
make -C ch27-win-kernel test        # build the target(s) and run the exploit test
```
